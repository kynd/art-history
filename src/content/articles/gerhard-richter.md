...
Richter grew up in Dresden under Nazism and then the East German state, where he trained in socialist-realist mural painting. In 1961, months before the Berlin Wall sealed the border, he moved west and enrolled at the Düsseldorf Academy, plunging into a very different world of Fluxus, Pop, and the freedoms of the Western market. In 1963 he and Sigmar Polke half-ironically named their response "Capitalist Realism." From then on Richter refused a single signature style, treating each mode — photo-painting, monochrome, colour chart, abstraction — as an experiment rather than a brand.

<!-- -->

リヒターは、ナチズム下の、そして次いで東ドイツのドレスデンで育ち、社会主義リアリズムの壁画を学びました。1961年、ベルリンの壁が国境を封じるほんの数か月前に西側へ移り、デュッセルドルフの美術学校に入学して、フルクサスやポップ、そして西側市場の自由という、まったく異なる世界へ飛び込みます。1963年、彼はジグマー・ポルケとともに、その応答を半ば皮肉を込めて「資本主義リアリズム」と名づけました。以後リヒターは、単一の署名的なスタイルを拒み、フォト・ペインティング、モノクローム、色見本、抽象といった各様式を、ブランドではなく実験として扱っていきます。
...
## When distance becomes ethics
## 距離が倫理になるとき

In later work the blur turns into a moral instrument. The cycle *October 18, 1977* (1988) painted the dead of the Baader-Meinhof group from police and press photographs, refusing both mourning and judgement. *September* (2005) renders the second plane striking the World Trade Center as an almost illegible smear — less an image of the attack than of how such images circulate and numb us. The *Birkenau* paintings (2014) go furthest: Richter began from four photographs taken clandestinely by prisoners at Auschwitz-Birkenau in 1944, then buried each canvas under scraped layers of abstract colour until the source is nearly gone. The result is not a depiction of the Holocaust but an inquiry into whether such depiction is possible at all.
...
<li>"The photograph is the most perfect picture… absolute… devoid of style" — quoted via Sotheby's. <a href="https://www.sothebys.com/" target="_blank" rel="noopener">Sotheby's</a></li>
<li>Gerhard Richter, <em>September</em> — David Zwirner; <em>Birkenau</em> — The Metropolitan Museum of Art. <a href="https://www.davidzwirner.com/artists/gerhard-richter" target="_blank" rel="noopener">David Zwirner</a> · <a href="https://www.metmuseum.org/" target="_blank" rel="noopener">The Met</a></li>
</ol>
